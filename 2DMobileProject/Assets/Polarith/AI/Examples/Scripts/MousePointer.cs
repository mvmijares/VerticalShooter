...
{
    /// <summary>
    /// Calculates the current mouse position for 2D scenes. It is also possible to display a crosshair at that position.
    /// <para/>
    /// Note, this is just a script used for our example scenes and therefore not part of the actual API. We do not
    /// guarantee that this script is working besides our examples.
    /// </summary>
    [AddComponentMenu("Polarith AI » Examples/Teleporter")]
