...
{
    /// <summary>
    /// Represents the basic configuration of a vehicle based on the <see cref="WheelCollider"/>. Wheelcoliders can be
    /// assigned as simple wheels, as <see cref="MotorWheels"/>, <see cref="BrakeWheels"/> and <see
    /// cref="SteeringWheels"/>. In either case, it is also possible to couple the visual representation with <see
    /// cref="WheelMeshes"/>.
    /// <para/>
    /// The <see cref="Move(float, float, float)"/> method acts as an interface between the vehicle physics and the
    /// user input which can be anything from AI to InputDevices.
    /// <para/>
    /// Note, this is just a script used for our example scenes and therefore not part of the actual API. We do not
    /// guarantee that this script is working besides our examples.
    /// </summary>
    [AddComponentMenu("Polarith AI » Examples/Vehicle Physics")]
