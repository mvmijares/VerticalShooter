...
{
    /// <summary>
    /// This component is used to spaw randomly distributed game objects inside a certain area, defined by <see
    ...
    /// spawn as childs of the <see cref="Parent"/> object.
    /// <para/>
    /// Note, this is just a script used for our example scenes and therefore not part of the actual API. We do not
    /// guarantee that this script is working besides our examples.
    /// </summary>
    [AddComponentMenu("Polarith AI » Examples/Object Spawner")]
    public sealed class ObjectSpawner : MonoBehaviour
    {
        ...
        // Determines if the given position is rejected or not, based on the <see cref="Restriction"/>. 
        // Returns <c>true</c> if the position is valid.
        private bool ValidatePosition(Vector3 position)
        {
            if (Restriction == RestrictionType.NavMeshArea)
            {
                // Check if point is on a valid NavMeshArea
                UnityEngine.AI.NavMeshHit navMeshAreaHitPoint;
                       ...
                       NavMeshAreaMask))
                {
                    ...
                    UnityEngine.AI.NavMeshHit closestHitEdge;
                    UnityEngine.AI.NavMesh.FindClosestEdge(position, out closestHitEdge, ~NavMeshAreaMask);
